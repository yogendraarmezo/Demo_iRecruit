...
@Entity
@Table(name = "test_casestudy_master")
public class TestCaseStudyMaster {
	...
	public TestCaseStudyMaster() {
		super();
		// TODO Auto-generated constructor stub
	}

	public TestCaseStudyMaster(Integer srNo, Integer testId, Integer sectionId, Integer categId,
			Integer difficultyId, String sectionName, String qidList, String marksDistList) {
		super();
